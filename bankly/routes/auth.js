...
router.post("/login", async function (req, res, next) {
  try {
    ...
    // BUG #2 FOUND: We are not awaiting User.authenticate, allowing unregistered users to gain access token
    // let user = User.authenticate(username, password);

    // BUG #2 FIXED: Simply add 'await' keyword to the bugged statement
